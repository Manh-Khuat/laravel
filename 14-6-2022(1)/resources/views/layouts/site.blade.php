...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="{{ url('/public/site') }}/img/logo.png" alt=""></a>
        </div>
        ...
        <div class="humberger__menu__widget">
            <div class="header__top__right__language">
                <img src="{{ url('/public/site') }}/img/language.png" alt="">
                <div>English</div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="{{ url('/public/site') }}/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
